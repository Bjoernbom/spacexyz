...
export const dashboardData = {
  flightNumber: mock.flight_number,
  missionName: mock.mission_name,
  launchDateUnix: mock.launch_date_unix,
  localLaunchDate: mock.launch_date_local,
  rocketName: mock.rocket.rocket_name,
  launchSiteName: mock.launch_site.site_name,
  links: {
